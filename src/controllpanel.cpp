...
ST_CP = 33,// black white
//pinkcolor is gnd led_oe
 LED_LE = 25/*blue*/,
 LED_OUT = 26/*green*/, 
BTN_IN = 27,//yellow //wrever=27
 CLK = 14, //orange wrover 14
...
enum LED_CONSTANTS
 {     BLINK = 2, FAST_BLINK, BLINK_INTERVAL = 800,
...
Buttons(PAUSE, 1, 0),                                                       //     1 | Scale increase. Hold=500ms.
...
{
if(homing&&mention_time_from_refrence_time_passed(5000,&uinvesal_previous_time))
{
  homing=0;
